const SocialsFooter = () => {
    return (
        <footer className='absolute bottom-44 left-1/2 flex min-h-8 w-1/4 min-w-fit -translate-x-1/2 select-none items-center justify-between gap-2 rounded-full border border-green-950 bg-gray-400 p-px text-center text-sm text-gray-100/20 hover:bg-gray-300 hover:text-gray-100'>
