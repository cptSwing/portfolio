const SocialsFooter = () => {
    return (
        <footer className='mt-4 flex min-h-8 w-1/4 min-w-fit select-none gap-2 rounded-full border border-green-950 bg-gray-400 p-px text-center text-sm text-gray-100/20 hover:bg-gray-300 hover:text-gray-100'>
