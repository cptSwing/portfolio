...
export const PostCards: FC<{
    ...
    return (
        <div className='shadow-with-top-xl h-full basis-1/2 overflow-hidden bg-theme-primary-300 shadow-theme-primary-950 outline outline-[length:--outline-width] outline-theme-primary-300'>
