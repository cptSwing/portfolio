...
const ParallaxMenuLayer: FC<{
    ...
    return (
        <div
            className={classNames(
                "pointer-events-none absolute bottom-0 left-0 right-0 top-0 m-auto transform overflow-hidden rounded-md transition-transform delay-500 duration-700 will-change-transform",
                parallaxLevelClassName,
                extraClassNames,
            )}
        >
        ...
        <div className="m-auto flex size-full flex-col items-center justify-start">
            ...
            <div className="flex h-[16.6666%] w-full items-start justify-start">
                ...
                <div className="relative h-full w-4/5">
                    ...
                    <div className="will-change-filter filter-bloom absolute bottom-0 left-1/2 mb-8 flex -translate-x-1/2 flex-col items-start justify-end rounded-md border-2 border-green-800 bg-green-1000 px-8 py-2">
                ...
                <div className="will-change-filter filter-bloom h-full w-[10%] border-b border-l border-green-900/50"></div>
            </div>
    ...
    return (
        <>
            ...
            <ParallaxMenuLayer
                ...
                content={
                    isEffectLayer ? (
                        <div className="ml-48 mr-auto mt-48">
            ...
            <ParallaxMenuLayer
                ...
                content={
                    isEffectLayer ? (
                        <div className="mb-48 ml-auto mr-48">
                            <TOCMenu menuHomeIsClickedState={menuHomeIsClickedState} />
                        </div>
                    ) : (
                        <></>
            ...
            {isEffectLayer && (
                <ParallaxMenuLayer
                    ...
                    extraClassNames={classNames(
                        "p-6 transition-transform delay-200 duration-300  h-2/3 w-4/5",
            ...
            <ParallaxMenuLayer
                key={-2.5}
                parallaxLevelClassName={classNames(menuHomeIsClicked ? "translate-z-16" : "-translate-z-16")}
                extraClassNames="p-8  h-2/3 w-4/5"
                content={
                    <div
                        className={classNames(
                            "will-change-filter filter-bloom h-1/5 w-1/5 translate-x-[400%] translate-y-1/4 rounded-md border-2 border-purple-400 p-1",
                            isEffectLayer
                                ? "pointer-events-auto cursor-pointer hover:border-2 hover:border-green-600"
                                : "pointer-events-none bg-gray-400",
                            menuHomeIsClicked ? "z-50" : "z-0",
                        )}
                    >
            ...
            <ParallaxMenuLayer
                key={-3.5}
                parallaxLevelClassName={classNames(menuHomeIsClicked ? "translate-z-16" : "-translate-z-40")}
                extraClassNames="p-8  h-2/3 w-4/5"
                content={
                    <div
                        className={classNames(
                            "will-change-filter filter-bloom h-1/5 w-1/5 translate-x-[300%] translate-y-[400%] rounded-md border-2 border-red-900 p-1",
                            isEffectLayer
                                ? "pointer-events-auto cursor-pointer hover:border-2 hover:border-red-400"
                                : "pointer-events-none bg-gray-400",
                            menuHomeIsClicked ? "z-50" : "z-0",
                        )}
                    >
            ...
            <ParallaxMenuLayer
                key={-1.5}
                parallaxLevelClassName={classNames(menuHomeIsClicked ? "translate-z-16" : "-translate-z-8")}
                extraClassNames="p-8  h-2/3 w-4/5"
                content={
                    <div
                        className={classNames(
...
const TOCMenu: FC<{ menuHomeIsClickedState: [boolean, React.Dispatch<React.SetStateAction<boolean>>] }> = ({ menuHomeIsClickedState }) => {
    ...
    return (
        <div className="pointer-events-auto w-1/5 border-2 border-slate-400 p-1.5">
