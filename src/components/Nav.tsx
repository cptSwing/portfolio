    ...
    return (
        <Link
            ...
            className={classNames(
                ...
                'group/link relative z-0 flex w-full cursor-pointer select-none items-center justify-end py-2 pl-2 no-underline',
        ...
        >
            <span
                className={classNames(
                    ...
                    'group-hover/link:from-[--nav-text] group-hover/link:via-red-500 group-hover/link:to-red-500 group-hover/link:[background-position:100%_100%] group-active/link:[background-position:100%_100%]',
