...
const Content = () => {
    ...
    return (
        <>
            <main className={classNames('relative z-50 -mb-[2px] flex justify-center')}>{activePost && <ContentWrapper_Test post={activePost} />}</main>
        </>
    );
};
...
const ContentWrapper_Test: FC<{
    ...
    const { title, subTitle, toolsUsed, images, textBlocks, codeLink } = post;
    ...
    return (
        <div
            ...
            className={classNames(
                ...
                post ? 'z-10 h-fit w-screen opacity-100' : '-z-10 h-0 w-full opacity-10',
            )}
        >
            ...
            >
                ...
                <div
                    className='relative flex flex-wrap gap-y-6 overflow-y-auto bg-palette-utility-bg px-14 py-6 scrollbar-thin'
                    style={{ height: window.innerHeight - topVal - 2 }}
