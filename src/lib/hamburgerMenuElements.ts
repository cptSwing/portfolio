    ...
    subMenuItems: [
        {
            ...
            subMenuItems: [
                ...
                {
                    name: 'Login',
                    iconPath: `url(${HAMBURGERMENUITEMS.Login})`,
                    iconSize: 50,
                    clickHandler: () => {},
                    // startOffset: 3,
                    isWorking: false,
                    ...
                    subMenuItems: [
                        {
                            ...
                            iconSize: 45,
                            clickHandler: () => openNewWindowOrRedirect('/pdfs/Jens_Brandenburg_CV.pdf'),
                            isLink: true,
                        },
                        {
                            name: 'Bio',
                        ...
                        },
                        {
                            ...
                            iconSize: 45,
                            clickHandler: () => openNewWindowOrRedirect('/pdfs/Jens_Brandenburg_Lebenslauf.pdf'),
                            isLink: true,
                        },
                    ],
                },
