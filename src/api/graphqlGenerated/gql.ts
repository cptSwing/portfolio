 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllPostsSlugsTitlesCategoriesFeaturedImages {\n  posts {\n    nodes {\n      slug\n      title\n      categories {\n        nodes {\n          slug\n        }\n      }\n      featuredImage {\n        node {\n          sourceUrl\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query GetAllPostsSlugsTitlesCategoriesFeaturedImages {\n  posts {\n    nodes {\n      slug\n      title\n      categories {\n        nodes {\n          slug\n        }\n      }\n      featuredImage {\n        node {\n          sourceUrl\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAllPostsTitlesSlugs {\n  posts {\n    nodes {\n      title\n      slug\n    }\n  }\n}"): (typeof documents)["query GetAllPostsTitlesSlugs {\n  posts {\n    nodes {\n      title\n      slug\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetPost($slug: ID!) {\n  post(id: $slug, idType: SLUG) {\n    title\n    slug\n    content\n  }\n}"): (typeof documents)["query GetPost($slug: ID!) {\n  post(id: $slug, idType: SLUG) {\n    title\n    slug\n    content\n  }\n}"];
