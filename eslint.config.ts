...
const config = defineConfig([
...

    {
        ...
        // optionally override rules here
    },
...
/** NOTE likely not needed anymore, but for old time's sake..:
    import { loadEnv } from 'vite';
    const env = loadEnv(process.env.NODE_ENV || 'development', process.cwd(), 'ASTRO');
    
    {
        // prevent --fix from changing the graphql autogenerated (type) files
        name: 'grapqhl codegen-specific',
        files: [env.ASTRO_GRAPHQL_CODEGEN_OUTPUT_FILE],
        linterOptions: {
